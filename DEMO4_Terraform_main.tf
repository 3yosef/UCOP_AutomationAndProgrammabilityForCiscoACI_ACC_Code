...
resource "aci_epg_to_contract" "example_consumer" {
  application_epg_dn = "uni/tn-terraform_demo1/ap-ap_1/epg-epg_1"
  contract_dn        = "uni/tn-terraform_demo1/brc-contract_epg1_epg2"
  contract_type      = "provider"
}


resource "aci_epg_to_contract" "example_provider" {
  application_epg_dn = "uni/tn-terraform_demo1/ap-ap_1/epg-epg_2"
  contract_dn        = "uni/tn-terraform_demo1/brc-contract_epg1_epg2"
